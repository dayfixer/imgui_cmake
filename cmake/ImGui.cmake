...
if (IMGUI_PLATFORM_WIN32)
    ...
    if (IMGUI_BACKEND_DX9)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_win32_dx9.cpp)
    ...
    elseif (IMGUI_BACKEND_DX10)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_win32_dx10.cpp)
    ...
    elseif (IMGUI_BACKEND_DX11)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_win32_dx11.cpp)
    ...
    elseif (IMGUI_BACKEND_DX12)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_win32_dx12.cpp)
...
elseif (IMGUI_PLATFORM_GLFW)
    ...
    message(STATUS "-- glfw importing...")
    add_subdirectory(glfw)
    message(STATUS "-- glfw imported")
    ...
    if (IMGUI_BACKEND_OPENGL2)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_glfw_opengl2.cpp)
    ...
    elseif (IMGUI_BACKEND_OPENGL3)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_glfw_opengl3.cpp)
        list(APPEND IMGUI_INTERFACE_LIBS opengl32 glfw)
    elseif (IMGUI_BACKEND_VULKAN)
        ...
        list(APPEND IMGUI_SOURCE_FILES ${Y_BACKEND_DIR}/backend_glfw_vulkan.cpp)
    endif ()

    list(APPEND IMGUI_INTERFACE_INCLUDES "${CMAKE_CURRENT_SOURCE_DIR}/glfw/include")
else ()
